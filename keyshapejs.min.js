...
v(c,"skewX(")&&(c=y(c.substring(6)),b[7]=c[0],c=a.shift());v(c,"skewY(")&&(c=y(c.substring(6)),b[8]=c[0],c=a.shift());v(c,"scale(")&&(c=y(c.substring(6)),b[10]=c[0],b[11]=A(c[1])?c[1]:c[0],c=a.shift());v(c,"translate(")&&(c=y(c.substring(10)),b[13]=c[0],b[14]=A(c[1])?c[1]:0)}}}function Y(a){this.D=a;this.B=[];this.w=[];this.s=0;this.o=this.a=this.c=null;this.h=this.f=this.g=0;this.b=1;this.i=this.C=this.m=!1}function I(a,b,c){b=a[b];void 0===b&&(b=a[c]);return b}function fa(a){return Array.isArray(a)?
