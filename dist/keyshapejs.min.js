...
qa=" translate translate    rotate skewX skewY  scale scale  translate translate".split(" "),aa="none url blur brightness contrast drop-shadow grayscale hue-rotate invert opacity saturate sepia".split(" "),U=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||null;U||=function(a){window.setTimeout(a,16)};var ra=/apple/i.test(navigator.vendor),Z={d:97,fill:48,fillOpacity:16,filter:80,height:33,
