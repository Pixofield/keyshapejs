...
window.KeyshapeJS=function(){function r(a){return"undefined"!==typeof a}function u(a,b){return a&&0===a.indexOf(b)}function X(a){var b={},c;for(c in a)b[c]=a[c];return b}function F(a){if(!isFinite(a))throw Error("Non-finite value");}function Y(a){if(14>=a)return 16;var b=Z[a];b||=r(ka[a])?0|(a.toLowerCase().indexOf("color")===a.length-5?48:0):1;return b}function N(a){return 0<=a?Math.pow(a,1/3):-Math.pow(-a,1/3)}function la(a,b,c,d){if(0===a)return 0===b?b=-d/c:(a=Math.sqrt(c*c-4*b*d),d=(-c+a)/(2*
b),0<=d&&1>=d?b=d:(d=(-c-a)/(2*b),b=0<=d&&1>=d?d:0)),b;var e=c/a-b*b/(a*a)/3;c=b*b*b/(a*a*a)/13.5-b*c/(a*a)/3+d/a;var f=c*c/4+e*e*e/27;b=-b/(3*a);if(0>=f){if(0===e&&0===c)return-N(d/a);a=Math.sqrt(c*c/4-f);d=Math.acos(-c/2/a);c=Math.cos(d/3);d=Math.sqrt(3)*Math.sin(d/3);a=N(a);e=2*a*c+b;if(0<=e&&1>=e)return e;e=-a*(c+d)+b;if(0<=e&&1>=e)return e;e=a*(d-c)+b;if(0<=e&&1>=e)return e}else{a=N(-c/2+Math.sqrt(f));c=N(-c/2-Math.sqrt(f));d=a+c+b;if(0<=d&&1>=d)return d;d=-(a+c)/2+b;if(0<=d&&1>=d)return d}return 0}
function ma(a,b){if(48===a&&"number"===typeof b)return"rgba("+(b>>>24)+","+(b>>>16&255)+","+(b>>>8&255)+","+(b&255)/255+")";if(64===a)return b=b.map(function(e){return e+"px"}),b.join(",");if(96===a){a="";for(var c=b.length,d=0;d<c;d+=2)a+=b[d],a+=b[d+1].join(",");return a}if(80===a){if(0===b[0])return"none";a="";c=b.length;for(d=0;d<c;)a+=aa[b[d]],1===b[d]?a+="("+b[d+1]+") ":5===b[d]?(a+="("+b[d+1]+"px "+b[d+2]+"px "+b[d+3]+"px rgba("+(b[d+4]>>>24)+","+(b[d+4]>>16&255)+","+(b[d+4]>>8&255)+","+(b[d+
4]&255)/255+")) ",d+=3):a=2===b[d]?a+("("+b[d+1]+"px) "):7===b[d]?a+("("+b[d+1]+"deg) "):a+("("+(0>b[d+1]?0:b[d+1])+") "),d+=2;return a}return 32===a?b+"px":b}function B(a){return 0>=a?0:255<=a?255:a}function na(a,b,c,d){if(16===a||32===a)return(c-b)*d+b;if(0===a)return.5>d?b:c;if(112===a)return 0>=d?b:1<=d?c:"visible";if(48===a){if("number"===typeof b&&"number"===typeof c){a=1-d;var e=a*(b>>>16&255)+d*(c>>>16&255),f=a*(b>>>8&255)+d*(c>>>8&255),m=a*(b&255)+d*(c&255);return B(a*(b>>>24)+d*(c>>>24))<<
...
1]-d;a=(a-e)/(b[4][c]-d-e);if(b[6]&&b[6].length>c-1)if(d=b[6][c-1],1===d[0])if(0>=a)a=0;else if(1<=a)a=1;else{e=d[1];var f=d[3];a=la(3*e-3*f+1,-6*e+3*f,3*e,-a);a=3*a*(1-a)*(1-a)*d[2]+3*a*a*(1-a)*d[4]+a*a*a}else 2===d[0]?(d=d[1],a=Math.ceil(a*d)/d):3===d[0]&&(d=d[1],a=Math.floor(a*d)/d);return na(b[1]&240,b[5][c-1],b[5][c],a)}function O(){C||(z=(new Date).getTime()+ca)}function T(a){if(a||!J){for(var b=!1,c=0;c<D.length;++c)D[c].O(a)&&(b=!0);if(a)for(;0<K.length;)if(a=K.shift(),c=a[0],1===a[1])c.onfinish&&
(c.onfinish(),b=!0),c.N();else if(2===a[1]&&c.onloop)c.onloop();return b}}function da(){O();T(!0)&&!C?(J=!0,U(da)):J=!1}function P(){J||(J=!0,U(da))}function ea(a,b){var c=[];a.split(b).forEach(function(d){c.push(parseFloat(d))});return c}function G(a){-1===a.indexOf(",")&&(a=a.replace(" ",","));return ea(a,",")}function fa(a){a._ks||(a._ks={});if(!a._ks.transform){for(var b=a._ks.transform=[],c=0;14>=c;++c)b[c]=0;b[10]=1;b[11]=1;if(a=a.getAttribute("transform")){a=a.trim().split(") ");for(c=a.length-
...
qa=" translate translate    rotate skewX skewY  scale scale  translate translate".split(" "),aa="none url blur brightness contrast drop-shadow grayscale hue-rotate invert opacity saturate sepia".split(" "),U=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||null;U||=function(a){window.setTimeout(a,16)};var ra=navigator.vendor.match(/apple/i),Z={d:97,fill:48,fillOpacity:16,filter:80,height:33,
...
this.v()&&V(this)},H:function(){if(!this.K){this.K=!0;for(var a=this.I,b=this.G,c=0;c<a.length;++c)for(var d=a[c],e=0;e<b[c].length;++e)14>=b[c][e][0]&&fa(d)}},C(a){if("number"===typeof a)return[a,0];if(!r(this.m.markers)||!r(this.m.markers[a]))throw Error("Invalid marker: "+a);a=this.m.markers[a];return r(a.time)?[+a.time,+(a.dur||0)]:[+a,0]},play:function(a){r(a)&&null!==a&&(a=this.C(a)[0],F(a),0>this.h&&a<this.l&&(a=this.l),0<this.h&&a>this.j&&(a=this.j),this.F(a,!0));if(!this.s)throw W;a=this.u();
if(0<this.h&&(null===a||a>=this.j||a<this.l))this.g=this.l;else if(0>this.h&&(null===a||a<=this.l||a>this.j)){if(Infinity===this.j)throw Error("Cannot seek to Infinity");this.g=this.j}else 0===this.h&&null===a&&(this.g=this.l);if(null===this.g)return this;this.i=null;this.A=!0;this.H();P();return this},pause:function(a){if(!this.s)throw W;r(a)&&(a=this.C(a)[0],F(a));if("paused"!==this.v()){O();var b=this.u();if(null===b)if(0<=this.h)this.g=this.l;else{if(Infinity===this.j)throw Error("Cannot seek to Infinity");
this.g=this.j}null!==this.i&&null===this.g&&(this.g=b);this.i=null;this.A=!1;this.J(!1);this.H();P()}r(a)&&this.F(a,!0);return this},range:function(a,b){if(0===arguments.length)return{"in":this.l,out:this.j};var c=this.C(a)[0],d=this.D;r(b)&&(d=this.C(b)[0]);F(c);if(0>c||0>d||c>=d||isNaN(d))throw Error("Invalid range");var e=this.v();this.l=c;this.j=d;"finished"===e&&"running"===this.v()&&this.play();return this},loop:function(a){if(!r(a))return{count:this.o};this.o=!0===a?Infinity:Math.floor(a);
if(0>this.o||isNaN(this.o))this.o=0;return this},u:function(){return null!==this.g?this.g:null===this.i?null:(z-this.i)*this.h},F:function(a,b){b&&O();null!==a&&(this.H(),null!==this.g||null===this.i||0===this.h?(this.g=a,T(!1)):this.i=z-a/this.h,this.s||(this.i=null),this.B=null,this.J(!0),P())},L:function(){return this.u()},time:function(a){if(r(a)){if(!this.s)throw W;a=this.C(a)[0];F(a);this.F(a,!0);return this}return this.L()},v:function(){var a=this.u();return this.A?"running":null===a?"idle":
...
g);var n=ja.indexOf(g);""!==g&&0<=n&&(g=n);n=Y(g);var p=H(h,"t","times");if(!p||2>p.length)throw Error("Not enough times");p=p.slice();if(!isFinite(p[0])||0>p[0])throw Error("Invalid time: "+p[0]);for(var w=1;w<p.length;++w)if(!isFinite(p[w])||0>p[w]||p[w]<p[w-1])throw Error("Invalid time: "+p[w]);w=p[0];var Q=p[p.length-1]-w,R=h.iterations||0;1>R&&(R=1);Q*=R;c<Q+w&&(c=Q+w);var I=H(h,"v","values");if(!I||I.length!==p.length)throw Error("Values do not match times");I=I.slice();for(var y=g,l=I,L=Y(y)&
...
t)t=[0];else{v=[];for(var x=t.indexOf("(");0<x;)if(A=aa.indexOf(t.substring(0,x)),0<=A){v.push(A);var S=t.indexOf(") ");0>S&&(S=t.length-1);x=t.substring(x+1,S).split(" ");5===A?(v.push(parseFloat(x[0])),v.push(parseFloat(x[1])),v.push(parseFloat(x[2])),v.push(pa(x[3]))):1===A?v.push(x[0]):v.push(parseFloat(x[0]));t=t.substring(S+1).trim();x=t.indexOf("(")}else break;t=v}E[M]=t}else 64===L?"none"!==l[q]?/^[0-9 .]*$/.test(l[q])?l[q]=ea(l[q]," "):(console.warn("unsupported value: "+l[q]),l[q]=[0]):
l[q]=[0]:32===L?(F(l[q]),l[q]=parseFloat(l[q])):0===y&&(l[q]=parseFloat(l[q]));y=H(h,"e","easing");l=p.length;for(y||=[];y.length<l;)y.push([1,0,0,.58,1]);for(l=0;l<y.length;++l)y[l]=oa(y[l]);n=[g,n,w,Q,p,I,y,R];p=H(h,"mp","motionPath");r(p)&&0===g&&(n[8]=[],n[8][0]=h.motionRotate,g=document.createElementNS("http://www.w3.org/2000/svg","path"),p||="M0,0",g.setAttribute("d",p),n[8][1]=g,n[8][2]=g.getTotalLength());h=H(h,"f","fill");r(h)&&(n[9]=h.slice());m.push(n)}0<m.length&&(a.I.push(e),a.G.push(m))}a.D=
c;a.l=0;a.j=a.D;ia(a);return a},add:ia,remove:V,removeAll:function(){for(var a=D.length-1;0<=a;--a)V(D[a]);return this},timelines:function(){return D.slice()},globalPlay:function(){C&&(ca=C-(new Date).getTime(),C=void 0,P());return this},globalPause:function(){C||(C=z,T(!1));return this},globalState:function(){return C?"paused":"running"}}}();
